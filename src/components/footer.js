            ...
            <footer className="footer-section">
                <div className="container-gt" id="footer-info">
                    ...
                    <p className="param-footer">
                        Charles A. Petty loves to hear from readers. You can reach him via email. 
                    ...
                    <nav>
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/Charles-A-Petty-105690031247509/"
                            ...
                            <li>
                                <a 
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/54900288-almost-a-spy" rel="noreferrer">
                                    <FontAwesomeIcon 
                                        className='font-awesome'
                                        icon={faGoodreads} />
                                </a>
